...
listTLasFiles = dir('/pfs/proj/nobackup/fs/projnb10/ecsbl/MOBILE/TCGA/PRAD/ETS/TLas1_r*'); 
...
a0Mats(qqtodel,:) = [];
TLasMats(qqtodel,:) = [];
save('/pfs/proj/nobackup/fs/projnb10/ecsbl/MOBILE/TCGA/PRAD/ETS/PRAD_ETS.mat','a0Mats','TLasMats','listTLasFiles','qqtodel','-v7.3') ;
...
load('PRAD_ETS.mat') % Load the Lasso coefficient matrices data if not in workspace already

[intranksR_PRAD_ETS,intsii_PRAD_ETS,numedges_PRAD_ETS,TLasTarget_PRAD_ETS] = ...
...
save('/pfs/proj/nobackup/fs/projnb10/ecsbl/MOBILE/TCGA/PRAD/ETS/TLasBestPRAD_ETS.mat','intranksR_PRAD_ETS','intsii_PRAD_ETS','numedges_PRAD_ETS','TLasTarget_PRAD_ETS','-v7.3') 
disp('DONE and saved')
