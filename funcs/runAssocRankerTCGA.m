function [intranks_r,intranks_ii,numedges,TLasTarget] = runAssocRankerTCGA(cutoffval,TLasMats,XX_Data,XX_IDs,YY_Data,YY_IDs)
...
intranks(:,11) = cellstr(YY_Data.antibody(YY_IDs(ii),:));
intranks(:,12) = cellstr(' ');%cellstr(YY_Data.pathway(YY_IDs(ii),:));
