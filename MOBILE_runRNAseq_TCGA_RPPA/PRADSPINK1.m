...
%%%%% Remove ETV and run: LOGO happens here
XX(:,SPINK1highIDs) = []; 
YY(:,SPINK1highIDs) = [];
...
listTLasFiles = dir('/pfs/proj/nobackup/fs/projnb10/ecsbl/MOBILE/TCGA/PRAD/SPINK1/TLas1_r*'); 
...
a0Mats(qqtodel,:) = [];
TLasMats(qqtodel,:) = [];
save('/pfs/proj/nobackup/fs/projnb10/ecsbl/MOBILE/TCGA/PRAD/SPINK1/PRAD_SPINK1.mat','a0Mats','TLasMats','listTLasFiles','qqtodel','-v7.3') ;
...
load('PRAD_SPINK1.mat') % Load the Lasso coefficient matrices data if not in workspace already

[intranksR_PRAD_SPINK1,intsii_PRAD_SPINK1,numedges_PRAD_SPINK1,TLasTarget_PRAD_SPINK1] = ...
...
save('/pfs/proj/nobackup/fs/projnb10/ecsbl/MOBILE/TCGA/PRAD/SPINK1/TLasBestPRAD_SPINK1.mat','intranksR_PRAD_SPINK1','intsii_PRAD_SPINK1','numedges_PRAD_SPINK1','TLasTarget_PRAD_SPINK1','-v7.3') 
disp('DONE and saved')